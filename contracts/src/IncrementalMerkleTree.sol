...
contract IncrementalMerkleTree {
    ...
    error IncrementalMerkleTree__IndexOutOfBounds(uint256 size);
    error IncrementalMerkleTree__MerkleTreeFull(uint256 currentIndex);
    ...
    bytes32 constant ZERO_0 = 0x0d823319708ab99ec915efd4f7e03d11ca1790918e8f04cd14100aceca2aa9ff;
    ...
    constructor(uint8 _depth, Poseidon2 _hasher) {
        ...
        i_depth = _depth;
        i_hasher = _hasher;
        // precompute all the zero subtrees
        s_roots[0] = zeros(_depth); // store the ID 0 root as the zero depth zero
    }
    /*////////////////////////////////////////////////////////////////////////////
                                   RECEIVE / FALLBACK
    ///////////////////////////////////////////////////////////////////////////*/
    ...
    function _insert(bytes32 _leaf) internal returns (uint32) {
        ...
        // do this all the way up to the tree root
        ...
        for (uint8 i = 0; i < i_depth; i++) {
            if (currentIndex % 2 == 0) {
                ...
                // - if index is odd, we need to put it on the right of the hash
                // and a cached subtree on the left
